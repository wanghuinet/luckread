...
> Status: **ACTIVE / MAPPING IN PROGRESS — BATCH 1**
>
...
- Batch 2: H–M → future content, feed, recommendation, search, social, community.
- Batch 3: N–T → messaging, notification, i18n, paid content, revenue, advertising, rights.
- Batch 4: U–AQ → trust/safety, governance, growth, analytics, SEO, clients, API/developer/admin, infrastructure, migration, reliability and extensions.
- Batch 5: freeze the **12 Worker Master** and bind every mapped feature/task to Worker IDs.
- Batch 6: freeze the **4 D1 Master** and bind every mapped feature/task to D1 Domain IDs.
- Batch 7: expand API/Data/Security/Event/Test/Evidence IDs and run orphan/duplicate/conflict reconciliation.
